...
$options_arg = new stdClass;
$options_arg->contextid   = $PAGE->context->id;

$block_phrasecommentjs = array(
		'name'     => 'block_phrasecomment',
		'fullpath' => '/blocks/phrasecomments/module.js',
		'requires' => array('base', 'io', 'node', 'json', 'yahoo', 'dom', 'selector','connectioncore','connection','event'),
		'strings'  => array( array('confirmdeletecomments', 'admin'), array('yes', 'moodle'), array('no', 'moodle'))
);
$PAGE->requires->js_init_call('M.block_phrasecomment.init',array($options_arg),true,$block_phrasecommentjs);
